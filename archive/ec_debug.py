...
def fetch_and_parse_events():
    ...
    # RESTORED STRICTLY TO ORIGINAL WHILE LOOP
    ...
    # RESTORED STRICTLY TO ORIGINAL CONCURRENT YFINANCE FETCH
                    ...
                    btnElement.innerHTML = `
                        <div class="w-full flex justify-center items-center py-2">
                            <div class="w-full bg-black/20 rounded-full h-1.5 overflow-hidden">
                                <div class="bg-black h-1.5 transition-all duration-300" style="width: ${percent}%"></div>
                            </div>
                        </div>`;
                }
            };
